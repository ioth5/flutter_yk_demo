...
import 'package:yk_demo/model/article.dart';
...
class ReaderSceneState extends State<ReaderScene> with RouteAware {
  ...
  void setup() async {
    ...
    List<dynamic> chaptersResponse = [
      {"id": 1000, "index": 0, "title": "第一章 落魄青年"},
      {"id": 1001, "index": 1, "title": "第二章 不吃霸王餐"},
      {"id": 1002, "index": 2, "title": "第三章 设计"},
      {"id": 1003, "index": 3, "title": "第四章 将计就计"},
      {"id": 1004, "index": 4, "title": "第五章 出手救治"},
      {"id": 1005, "index": 5, "title": "第六章 美女请吃饭"},
      {"id": 1006, "index": 6, "title": "第七章 没有免费的午餐"}
    ];
