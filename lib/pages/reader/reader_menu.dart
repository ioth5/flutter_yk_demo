...
import 'package:yk_demo/model/chapter.dart';
import 'dart:async';
...
class _ReaderMenuState extends State<ReaderMenu>
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              width: 44,
              child: Image.asset(Constant.ASSETS_IMG + 'read_icon_voice.png'),
            ),
            Container(
              width: 44,
              child: Image.asset(Constant.ASSETS_IMG + 'read_icon_more.png'),
            ),
          ],
        ),
      ),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(
              ...
              child: Image.asset(
                  Constant.ASSETS_IMG + 'read_icon_chapter_previous.png'),
            ),
          ),
          Expanded(
            child: Slider(
          ...
          GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.all(20),
              child: Image.asset(
                  Constant.ASSETS_IMG + 'read_icon_chapter_next.png'),
            ),
          )
        ],
      ),
  ...
  buildBottomMenus() {
    return Row(
      ...
      children: <Widget>[
        buildBottomItem('目录', Constant.ASSETS_IMG + 'read_icon_catalog.png'),
        buildBottomItem('亮度', Constant.ASSETS_IMG + 'read_icon_brightness.png'),
        buildBottomItem('字体', Constant.ASSETS_IMG + 'read_icon_font.png'),
        buildBottomItem('设置', Constant.ASSETS_IMG + 'read_icon_setting.png'),
      ],
    );
  }
