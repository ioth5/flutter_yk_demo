...
class NovelDetailHeader extends StatelessWidget {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Image.asset(Constant.ASSETS_IMG + 'read_icon_vip.png'),
                    Expanded(
                      child: Text(
                        ' 续费包月会员，万本小说免费读 >',
                        style: TextStyle(
  ...
  Widget buildScore() {
    ...
    for (var i = 0; i < 5; i++) {
      ...
      var img;
      if (star <= i + 0.5) {
        img = Image.asset(Constant.ASSETS_IMG + 'detail_star_half.png');
      } else {
        img = Image.asset(Constant.ASSETS_IMG + 'detail_star.png');
      }
      children.add(img);
